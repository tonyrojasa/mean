(function () {
  ...
  angular
    ...
    .factory('OpenItemsService', OpenItemsService);

  OpenItemsService.$inject = ['$resource', '$log'];

  function OpenItemsService($resource, $log) {
    var Item = $resource('/api/items/open/:itemId', {
      itemId: '@_id'
    }, {
        update: {
          method: 'PUT'

(function () {
  ...
  angular
    ...
    .factory('CloseItemsService', CloseItemsService);

  CloseItemsService.$inject = ['$resource', '$log'];

  function CloseItemsService($resource, $log) {
    var Item = $resource('/api/items/close/:itemId', {
      itemId: '@_id'
    }, {
      update: {
        method: 'PUT'

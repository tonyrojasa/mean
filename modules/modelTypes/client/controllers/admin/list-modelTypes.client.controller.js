(function () {
  ...
  ModelTypesAdminListController.$inject = ['ModelTypesService', '$filter', 'Authentication'];

  function ModelTypesAdminListController(ModelTypesService, $filter, Authentication) {
    var vm = this;
